...
class SqlUtilsTest {
  ...
  public void quoteListParam() {
    ...
    assertEquals(
        "(100.11222,99)",
        SqlUtils.quoteParam(Arrays.asList(BigDecimal.valueOf(100.11222), BigDecimal.valueOf(99))));
    assertEquals(
        "('2021-01-15','2021-01-16')",
        SqlUtils.quoteParam(
            Arrays.asList(LocalDate.parse("2021-01-15"), LocalDate.parse("2021-01-16"))));
